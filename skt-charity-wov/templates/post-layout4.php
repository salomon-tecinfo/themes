            ...
            <div class="lay4_wrap">
                ...
                <!--POST THUMBNAIL START-->
                        <div class="post_image">
                          ...
                          <div class="imgwrap">
							<div class="icon_wrap animated fadeInUp">
                              		<a href="<?php the_permalink();?>" title="<?php echo _e('Leer más','complete'); ?>"><i class="fa fa-plus"></i></a>
                            </div>
                 ...
                 <!--POST THUMBNAIL END-->
                    ...
                    <!--POST CONTENT END-->
					<!--Read More Button-->
                    <div class="blog_mo"><a href="<?php the_permalink();?>">+ <?php _e('Leer más', 'complete'); ?></a></div>
