...
//========================= ADD SECTIONS==============================
        ...
        $wp_customize->add_section( 'wooshoplayout_section', array(
            'title'       => __( 'Woo Shop Page Layout', 'complete' ),
            'priority'    => 10,
            'panel'       => 'singlepages_panel',
			'description' => '',
        ) );		
		
        $wp_customize->add_section( 'woosinglelayout_section', array(
            'title'       => __( 'Woo Single Product Layout', 'complete' ),
            'priority'    => 10,
            'panel'       => 'singlepages_panel',
			'description' => '',
        ) );				
